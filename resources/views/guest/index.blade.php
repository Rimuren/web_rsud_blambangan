        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-6 mb-6 md:mb-8">
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                ...
                <div class="p-4">
                    ...
                    <h4 class="text-sm font-bold text-gray-900 mt-1.5 mb-2 leading-snug">Sentuhan Kasih Merawat Bayi dengan Prematuritas</h4>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all">
                ...
                <div class="p-4">
                    ...
                    <h4 class="text-sm font-bold text-gray-900 mt-1.5 mb-2 leading-snug">Hotline Al_Apoteker Isun | Konsultasi Obat</h4>
            ...
            <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all sm:col-span-2 md:col-span-1">
                ...
                <div class="p-4">
                    ...
                    <h4 class="text-sm font-bold text-gray-900 mt-1.5 mb-2 leading-snug">Hotline Gancang Aron - Siaga 24 Jam</h4>
