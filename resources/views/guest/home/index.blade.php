...
<head>
    ...
    <title>RSUD Blambangan | Layanan Kesehatan Profesional & Terpercaya</title>
        ...
        <div class="container mx-auto">
            ...
            <div class="bg-white rounded-2xl overflow-hidden grid md:grid-cols-2 shadow-lg mb-6 md:mb-8">
                ...
                <div class="p-6 md:p-8">
                    ...
                    <h3 class="text-[#03007A] text-2xl md:text-4xl font-bold leading-snug mt-2 mb-3">
                        Area Spesialisasi Medis yang Berkomitmen pada Keunggulan Medis &amp; Layanan
                    </h3>
                    <p class="text-[#707070] text-sm leading-relaxed mb-5 max-w-xl">
            ...
            {{-- Service Cards (loop untuk efisiensi) --}}
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-5">
                @php
                    $services = [
                        ['title' => 'Digital Subtraction Angiography', 'img' => 'dsa.jpg', 'bg' => 'from-[#1a2744] to-[#243558]'],
                        ['title' => 'Cath Lab', 'img' => 'cathlab.jpg', 'bg' => 'from-[#1a2744] to-[#243558]'],
                        ['title' => 'Hemodialysis Center', 'img' => 'hemo.jpg', 'bg' => 'from-[#0f5c6e] to-[#1a7a8f]'],
                        ['title' => 'Oncology & Chemotherapy', 'img' => 'onco.jpg', 'bg' => 'from-[#5c1a1a] to-[#8f3333]'],
                    ];
                @endphp
                @foreach ($services as $service)
                    <div class="service-card relative rounded-2xl overflow-hidden h-40 md:h-48 group cursor-pointer shadow-md">
                        <img src="{{ asset('build/assets/' . $service['img']) }}" alt="{{ $service['title'] }}"
