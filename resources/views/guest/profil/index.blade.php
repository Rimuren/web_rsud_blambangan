...
<section class="bg-blue-50 py-16 px-6 text-center">
  <div class="max-w-2xl mx-auto">
    <!-- Icon Box - diperbaiki ukuran dan background -->
  ...
  <section class="max-w-6xl mx-auto px-6 pb-8 pt-12">
    <div class="rounded-3xl px-10 py-14 text-center text-white" style="background-color: #0F3D5E;">
      <!-- Label with lines -->
      ...
      <h2 class="text-3xl font-bold mb-8">Komitmen Kami Kepada Masyarakat</h2>
  ...
  <section class="max-w-6xl mx-auto px-6 py-12">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <!-- VISI Card -->
      <div class="rounded-2xl p-8 text-white" style="background-color: #0F3D5E;">
      ...
      <div class="rounded-2xl p-8 text-white" style="background-color: #0F3D5E;">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex items-start gap-3">
            <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5" style="background-color: #2BB7A3; color: white;">1</div>
          ...
          <!-- Misi 2 -->
          <div class="flex items-start gap-3">
            <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5" style="background-color: #2BB7A3; color: white;">2</div>
          ...
          <!-- Misi 3 -->
          <div class="flex items-start gap-3">
            <div class="w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0 mt-0.5" style="background-color: #2BB7A3; color: white;">3</div>
  ...
  <section class="max-w-6xl mx-auto px-6 py-12">
    ...
    <div class="flex items-center gap-3 mb-8">
      <div class="w-1 h-7 rounded-full" style="background-color: #2BB7A3;"></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <!-- Card 1: IGD 24 Jam -->
      <div>
        <div class="relative rounded-xl overflow-hidden mb-4" style="height: 200px;">
          <img
          ...
          <div class="absolute top-3 left-3 w-8 h-8 rounded-lg flex items-center justify-center bg-white/90">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" style="color: #2BB7A3;" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <h3 class="font-bold text-gray-900 mb-1">IGD 24 Jam</h3>
        <p class="text-gray-500 text-sm leading-relaxed">Siaga melayani kondisi darurat kapan saja dengan tim medis ahli.</p>
      </div>

      <!-- Card 2: Laboratorium Modern -->
      <div>
        <div class="relative rounded-xl overflow-hidden mb-4" style="height: 200px;">
          <img
            src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=500&auto=format&fit=crop"
        ...
        <h3 class="font-bold text-gray-900 mb-1">Laboratorium Modern</h3>
        <p class="text-gray-500 text-sm leading-relaxed">Fasilitas pengujian medis lengkap dengan hasil yang cepat dan akurat.</p>
      </div>

      <!-- Card 3: Rawat Inap VVIP -->
      <div>
        <div class="relative rounded-xl overflow-hidden mb-4" style="height: 200px;">
          <img
            src="https://images.unsplash.com/photo-1598256989261-7f657bc3e10e?w=500&auto=format&fit=crop"
            alt="Rawat Inap VVIP"
            class="w-full h-full object-cover"
          />
          <div class="absolute top-3 left-3 w-8 h-8 rounded-lg flex items-center justify-center bg-white/90">
        ...
        <h3 class="font-bold text-gray-900 mb-1">Rawat Inap VVIP</h3>
        <p class="text-gray-500 text-sm leading-relaxed">Kamar perawatan yang nyaman dengan fasilitas setara hotel berbintang.</p>
      </div>
    </div>
  </section>
  ...
  <section class="max-w-6xl mx-auto px-6 pb-16">
    <div class="flex flex-col md:flex-row items-center justify-between gap-6 rounded-2xl border-2 border-dashed px-8 py-6" style="border-color: #2BB7A3; background-color: #f0fdfa;">
      <!-- Left -->
      <div class="flex items-center gap-4">
        <!-- Phone Icon -->
        <div class="w-11 h-11 rounded-full flex items-center justify-center flex-shrink-0" style="background-color: #e6faf8;">
          <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" style="color: #2BB7A3;" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
      ...
      <!-- Right: Button -->
      <button class="text-white text-sm font-semibold px-6 py-3 rounded-xl shadow-md hover:opacity-90 transition whitespace-nowrap" style="background-color: #0F3D5E;">
        Hubungi Kami: (0333) 3627289
      </button>
    </div>
  </section>
