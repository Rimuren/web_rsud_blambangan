...
<style>
    ...
    /* Stagger delays for support cards */
    .stagger-support:nth-child(1) { transition-delay: 0.05s; }
    .stagger-support:nth-child(2) { transition-delay: 0.1s; }
    .stagger-support:nth-child(3) { transition-delay: 0.15s; }
    .stagger-support:nth-child(4) { transition-delay: 0.2s; }
</style>
        ...
        <div class="max-w-5xl mx-auto">
            <div class="bg-[#e4ecf4] rounded-2xl px-6 py-8 md:px-8 md:py-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="flex gap-4 items-start bg-white rounded-xl p-4 shadow-sm hover:shadow-md transition fade-up stagger-support">
...
<script>
    (function() {
        ...
        // Fallback untuk elemen yang sudah terlihat sebelum observer
        ...
        // Efek hover pada card dukungan
        const supportCards = document.querySelectorAll('.stagger-support');
