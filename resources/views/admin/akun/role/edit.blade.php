    ...
    <flux:main>
        <div class="py-6 px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto">
                ...
                {{-- Header halaman --}}
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Edit Role</h1>
                    <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Ubah nama role dan permission yang dimiliki.</p>
                </div>

                {{-- Form Card --}}
                <div class="bg-white dark:bg-zinc-800 rounded-2xl shadow-sm border border-zinc-200 dark:border-zinc-700">
                    <form action="{{ route('admin.akun.role.update', $role->id) }}" method="POST" class="divide-y divide-zinc-100 dark:divide-zinc-700">
                        @csrf
                        @method('PUT')
