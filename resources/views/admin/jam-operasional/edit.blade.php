...
<div class="p-4 md:p-6 lg:p-8">
    <div class="max-w-3xl mx-auto space-y-6">
        <div>
            <h1 class="text-3xl font-black tracking-tight text-zinc-900 dark:text-white">Edit Jam Operasional</h1>
            <p class="mt-2 text-zinc-500 dark:text-zinc-400">Perbarui hari layanan dan jam operasional yang sudah tersimpan.</p>
        </div>
        ...
        <div class="overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
            <div class="border-b border-zinc-200 bg-gradient-to-r from-amber-50 via-white to-sky-50 px-6 py-5 dark:border-zinc-800 dark:from-amber-950/20 dark:via-zinc-900 dark:to-sky-950/30">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-zinc-900 dark:text-white">Perbarui Data</h2>
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">Pastikan hari dan jam operasional sudah sesuai.</p>
                    </div>
                </div>
            </div>
