...
<footer class="bg-white text-[#1a2e4a] pt-12 pb-6 border-t border-gray-200">
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-10">

            <!-- Kolom 1: Branding -->
            <div>
                <h4 class="font-extrabold text-xl mb-3 tracking-wide text-[#0d2a4a]">RSUD BLAMBANGAN</h4>
                <p class="text-sm leading-relaxed text-[#4a5a6a] mb-5">
                    Berdiri sejak tahun 1930 sebagai Pusat Kesehatan Sederhana jaman Belanda
                </p>
                <div class="flex gap-3">
                    <!-- Twitter -->
                    <a href="#" class="w-10 h-10 rounded-full border-2 border-[#1a3a5c] flex items-center justify-center hover:bg-[#1a3a5c] hover:text-white text-[#1a3a5c] transition">
            ...
            <div>
                ...
                <ul class="text-sm space-y-4 text-[#1a2e4a]">
                    ...
                    <li class="flex items-start gap-3">
                        <div class="mt-0.5 w-8 h-8 bg-[#e8f0fe] rounded flex items-center justify-center flex-shrink-0">
                            <svg class="w-4 h-4 text-[#0d6efd]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                        </div>
                        <div>
        ...
        <div class="border-t border-gray-200 mt-10 pt-5 text-center text-xs text-gray-400">
            &copy; {{ date('Y') }} RSUD Blambangan. All rights reserved.
        </div>
    </div>
</footer>