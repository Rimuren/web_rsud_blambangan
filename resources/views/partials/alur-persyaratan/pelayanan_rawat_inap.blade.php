<!-- SECTION 4: Pelayanan Instalasi Rawat Inap                   -->
...
<div class="flex items-center gap-4 mb-5">
  ...
  <h2 class="text-xl font-bold text-[#0f2d5e]">4. Pelayanan Instalasi Rawat Inap</h2>
</div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-5">
  ...
  <div class="grid grid-cols-[48px_200px_1fr] px-5 py-5 border-b border-gray-100 items-start">
    ...
    <div class="flex flex-col gap-1.5">
      <p class="text-sm text-gray-600">Surat pengantar / permintaan rawat inap</p>
      <p class="text-sm text-gray-600">Kartu identitas / KTP / KK</p>
      <p class="text-sm text-gray-600">Kartu BPJS / Kartu Asuransi lain</p>
  ...
  <div class="grid grid-cols-[48px_200px_1fr] px-5 py-5 border-b border-gray-100 items-start">
    ...
    <div class="flex flex-col gap-4">
      ...
      <!-- Flow diagram: 3 rows x 2 cols with arrows -->
      <div class="bg-orange-50 border border-orange-100 rounded-xl p-4 flex flex-col gap-3">
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="flex-1 bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-xs font-medium text-gray-700 shadow-sm text-center">
            Petugas Mengantarkan Ke Rawat Inap
          </div>
          <svg class="w-4 h-4 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
          </svg>
        ...
        <div class="flex items-center gap-2">
          ...
          <div class="flex-1 bg-white border border-gray-200 rounded-lg px-3 py-2.5 text-xs font-medium text-gray-700 shadow-sm text-center">
            Asuhan Medis &amp; Keperawatan, Perencanaan Pulang
          </div>
          <svg class="w-4 h-4 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7"/>
          </svg>
      ...
      <div class="grid grid-cols-2 gap-x-6 gap-y-3">
        ...
        <div class="flex items-start gap-2">
          ...
          <p class="text-sm text-gray-600 leading-snug">Petugas mengantar pasien ke ruang rawat inap</p>
        </div>
        <div class="flex items-start gap-2">
          ...
          <p class="text-sm text-gray-600 leading-snug">Serah terima pasien dan orientasi ruangan</p>
        </div>
        <div class="flex items-start gap-2">
          ...
          <p class="text-sm text-gray-600 leading-snug">Asuhan medis &amp; keperawatan selama perawatan</p>
        </div>
        <div class="flex items-start gap-2">
        ...
        <div class="flex items-start gap-2">
          ...
          <p class="text-sm text-gray-600 leading-snug">Penyelesaian administrasi di kasir / UPP</p>
        </div>
        <div class="flex items-start gap-2">
          ...
          <p class="text-sm text-gray-600 leading-snug">Pasien pulang / dirujuk</p>
        </div>
      </div>
  ...
  <div class="grid grid-cols-[48px_200px_1fr] px-5 py-5 border-b border-gray-100 items-start">
    ...
    <div class="flex flex-col gap-2 w-full">
      <div class="flex justify-between items-center">
        ...
        <span class="text-sm text-gray-700 font-medium">Perda Kab. Banyuwangi No. 1 Th 2024</span>
      </div>
      <div class="flex justify-between items-center">
  ...
  <div class="grid grid-cols-[48px_200px_1fr] px-5 py-5 border-b border-gray-100 items-center">
    ...
    <p class="text-sm text-gray-600">Pelayanan rawat inap</p>
  </div>
