...
<div class="flex flex-col sm:flex-row sm:items-center items-start gap-3 mt-6 mb-6">
    ...
    <h1 class="text-xl font-bold text-[#0f2d5e]">4. Pelayanan Instalasi Rawat Inap</h1>
</div>
    ...
    @php
        $rows = [
            ...
            [
                ...
                'content_type' => 'badge',
                'badge_text' => 'Waktu sampai di ruang rawat inap 1 jam',
            ...
            [
                ...
                'content_type' => 'text',
                'text_value' => 'Pelayanan rawat inap'
            ],
            [
                'no' => 6,
